...
Which results in: :download_file:`sample.pdf </_static/sample.pdf>|true` or :download_file:`/_static/sample.pdf|true` or :download_file:`/_static/sample.pdf` or :download_file:`/_static/sample.pdf|false`.
